...
public class KeyboardInput implements KeyListener {
    ...
    public KeyboardInput() {
        ...
        currentStates.put(KeyEvent.VK_Q, Boolean.FALSE);
    ...
    public boolean dropSlow() {
        return keyDown(KeyEvent.VK_D);
    }
    
    public boolean savedPiece() {
        return keyDown(KeyEvent.VK_Q);
    }
    
    public boolean recoveredSavedPiece() {
